...
//controlRateConfig->rates[FD_ROLL] = 20;
...
static void resetConf(void)
{
    ...
    //Drona aux config
    modeActivationCondition_t *mac_1 = &currentProfile->modeActivationConditions[0];//modeActivationCondition
